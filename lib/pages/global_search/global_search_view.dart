...
class GlobalSearchPage extends StatelessWidget {
  ...
  Widget _buildContactsListView() => logic.searchKey.isNotEmpty && logic.contactsList.isEmpty
      ? _emptyListView
      : ListView(
    padding: EdgeInsets.only(top: 10.h),
  ...
  Widget _buildGroupListView() => logic.searchKey.isNotEmpty && logic.groupList.isEmpty
      ? _emptyListView
      : ListView(
    padding: EdgeInsets.only(top: 10.h),
  ...
  Widget _buildChatHistoryListView() => logic.searchKey.isNotEmpty && logic.textSearchResultItems.isEmpty
      ? _emptyListView
      : SmartRefresher(
  ...
  Widget _buildFileListView() => logic.searchKey.isNotEmpty && logic.fileMessageList.isEmpty
      ? _emptyListView
      : SmartRefresher(
