const Map<String, String> zh_CN = {
  ...
  "plsEnterEnterpriseName": "请输入您的机构名称",
  "plsEnterWebsite": "请输入您的官网地址",
  "plsUploadAvatar": "请上传您的头像",
  "plsEnterValidWebsite": "请输入有效的官网地址",
  "enterpriseNameLengthInvalid": "企业名称长度需为8-20个中文字或8-32个英文字符",
  "nicknameLengthInvalid": "昵称长度需为2-8个中文字或2-16个英文字符",
  "maxTagsLimit": "最多添加5个标签",
  "plsSelectAvatar": "请选择上传您的头像",
  "setInfo": "设置信息",
  ...
  "logout": "退出登录",
  "qrcode": "二维码",
  "tagsInputHint":"输入标签后按回车添加或者+号添加",
